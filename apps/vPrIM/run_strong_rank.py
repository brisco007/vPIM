...
applications = {"VA"       : ["NR_DPUS=X NR_TASKLETS=Y BL=Z make all", "./bin/host_code -w 0 -e 1 -i 2621440 -x 1"], 
                ...
                "NW_old"       : ["NR_DPUS=X NR_TASKLETS=Y BL=Z BL_IN=2 make all", "./bin/nw_host -w 0 -e 1 -n 2560"],
            ...
            for r in NR_DPUS:
                for t in NR_TASKLETS:
                    for b in BL:
                        ...
                        if is_native: 
                            r_cmd = r_cmd +  " > ../single_results/native/"+app_name+"_"+str(r)
                        else:
                            r_cmd = r_cmd +  " > ../single_results/vPIM/"+app_name+"_"+str(r)
