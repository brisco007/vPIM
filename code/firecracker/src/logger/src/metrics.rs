...
/// vPIM Device associated metrics.
#[derive(Default, Serialize)]
pub struct VPIMDeviceMetrics {
    /// Number of times when activate failed on a balloon device.
    pub activate_fails: SharedIncMetric,
    /// Number of incrementations that has been done.
    pub increment_count: SharedIncMetric,
...
pub struct FirecrackerMetrics {
    ...
    /// A vPIM device related metrics
    pub vpim: VPIMDeviceMetrics,
