...
/*
This file is responsible to expose the attributes in the /sys/class
directory as files for the SDK to read.
The functions implemented below tells these files what to show
when they are read
*/
