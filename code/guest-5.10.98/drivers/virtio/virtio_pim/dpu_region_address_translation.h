...
extern struct dpu_region_address_translation virtio_translate;

enum backend {
	DPU_BANKEND_VIRTIO = 0
};
...
struct dpu_region_address_translation {
	...
	void (*write_to_rank_batch)(struct dpu_region_address_translation *tr,
			      void *base_region_addr, uint8_t channel_id);
	...
	void (*write_to_cis_batch)(struct dpu_region_address_translation *tr,
			     void *base_region_addr, uint8_t channel_id,
			     void *block_data);
	...
	void (*request_config)(struct dpu_region_address_translation *tr);
	void (*realloc_config)(struct dpu_region_address_translation *tr);
	void (*free_rank)(struct dpu_region_address_translation *tr);
